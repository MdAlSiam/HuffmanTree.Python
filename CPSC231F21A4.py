...
def main():
    ...
    python CPSC231F21A4.py <input_filename1> <input_filename2>
        Creates Huffman Tree for <input_filename1> and <input_filename1> 
        and determines if structure of the trees are equal.
    ...
    -V          
        (optional) argument that turns on more detailed printing 
        (repr instead of str and tree structure output)
